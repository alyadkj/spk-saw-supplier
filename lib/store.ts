...
const DEFAULT_SUPPLIERS: Supplier[] = [
  { id: '1', nama: 'PT Sumber Kortas', kontak: '081234567890', email: 'sumberkortas@email.com', alamat: 'Jl. Industri Percetakan No.1, Jakarta' },
...
const DEFAULT_PENILAIAN: Penilaian[] = [
  // A1: PT Sumber Kortas (80, 90, 85, 88, 80)
